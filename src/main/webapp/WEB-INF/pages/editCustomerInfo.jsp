...
<form:form method="POST" modelAttribute="customerForm"
           action="${pageContext.request.contextPath}/editCustomerInfo">

    <table>
        <tr>
            <td>Username *</td>
            <td><form:hidden path="userName"/>${customerForm.userName}</td>
            <td><form:errors path="userName" class="error-message" /></td>
        </tr>
        <tr>
            <td>ID *</td>
            <td><form:hidden path="userId"/>${customerForm.userId}</td>
            <td><form:errors path="userName" class="error-message" /></td>
        </tr>
        <tr>
            <td>Name *</td>
