...
<c:if test="${not empty cartForm and not empty cartForm.cartLines   }">
    <form:form method="POST" modelAttribute="cartForm"
            ...
            <div class="product-preview-container">
                <ul>
                    <li><img class="product-image"
                             src="${pageContext.request.contextPath}/productImage?id=${cartLineInfo.productInfo.productId}" />
                    </li>
                    ...
                    <li><a
                            href="${pageContext.request.contextPath}/shoppingCartRemoveProduct?id=${cartLineInfo.productInfo.productId}">
                        Delete </a></li>
                </ul>
            </div>
        </c:forEach>
        ...
        <c:if test="${pageContext.request.userPrincipal.name != null}">
            <a class="navi-item"
               href="${pageContext.request.contextPath}/shoppingCartCustomer">Check the customer info</a>
        </c:if>
